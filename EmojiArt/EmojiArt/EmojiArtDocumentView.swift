...
struct EmojiArtDocumentView: View {
    ...
    init(emojiArtDocument: EmojiArtDocument) {
        self.document = emojiArtDocument
        _chosenPalette = State(wrappedValue: emojiArtDocument.defaultPalette)
    }
                    ...
                    Image(systemName: "doc.on.clipboard").imageScale(.large)
                        .alert(isPresented: $explainBackgroundPaste) {
                            Alert(title: Text("Paste Background"),
                                  message: Text("Copy the URL of an image to clip board and touch this button to make it the background of you document."),
