...
class EmojiArtDocumentStore: ObservableObject
{
    ...
    // TODO: if name already exists in documentNames, probably, UI should show alert or something like that
    ...
    init(directory: URL) {
        ...
        do {
            ...
            print("EmojiArt document store couldn't create store from directory \(directory): \(error.localizedDescription)")
        }
    }
}
